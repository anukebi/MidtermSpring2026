...
public class CardMapper {
  ...
  private static CardColor getCardColor(String code) {
    var colorCode = code.substring(0, 1);
    return CardColor.fromCode(colorCode);
  }

  private static CardRank getCardRank(String code, CardColor cardColor) {
    var rankCode = code.substring(1);
    return CardRank.fromCode(rankCode, cardColor);
  }

  private static Integer getCardValue(String code, CardColor color, CardRank rank) {
    return switch (rank) {
